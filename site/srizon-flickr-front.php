...
function srz_flickr_enqueue_script()
{
    ...
    wp_enqueue_script('srzcustom', srz_flickr_get_resource_url('resources/js/srizon.custom.min.js'), array('jquery'), '3.5.0');
    ...
    wp_enqueue_style('srzcustomcss', srz_flickr_get_resource_url('resources/css/srizon.custom.min.css'), null, '3.5.0');
}
